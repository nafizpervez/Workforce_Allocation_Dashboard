 ...
 *   projects    (id, code, name, client, budget, spent_pct, end_date, stage,
 *                progress, color, priority, created_at,
 *                product_amount, account_name, product_name,
 *                opportunity_owner, opp_amount, probability)
...
function createSchema(db) {
  ...
  /* Migration: only the columns we actually use */
...
/* =============================================================================
   28 PS Report projects from Excel (PSreport.xlsx) — slimmed to fields in use
   ============================================================================= */
const EXCEL_PROJECTS = [
  ...
  { code: 'SA136260', product_amount: 190, account_name: 'Independent University Bangladesh', product_name: 'PS System Support', name: 'ArcGIS Medium Lab: 2026-2027', end_date: '2026-04-09', opportunity_owner: 'Basher Muhammad Raquibul Raquibul', opp_amount: 1127.65, probability: 100, stage: 'Closed Won', priority: 'Low', color: '#A855F7' },
  { code: 'SA129008', product_amount: 5320, account_name: '24 Engineer Construction Brigade', product_name: 'PS System Support', name: 'Esri SW for BD Army 24 Engineers', end_date: '2026-04-30', opportunity_owner: 'Basher Muhammad Raquibul Raquibul', opp_amount: 45699.8, probability: 100, stage: 'Closed Won', priority: 'High', color: '#0EA5E9' },
  { code: 'SA137026', product_amount: 190, account_name: 'BRAC', product_name: 'PS System Support', name: 'AGOL PRO PLUS for BRAC', end_date: '2026-05-17', opportunity_owner: 'Basher Muhammad Raquibul Raquibul', opp_amount: 799.9, probability: 100, stage: 'Closed Won', priority: 'Low', color: '#EAB308' },
  { code: 'SA132317', product_amount: 3005, account_name: 'Directorate of Technical Education', product_name: 'PS Project Implementation', name: 'DTE_ArcGIS_Pro_Advance', end_date: '2026-05-20', opportunity_owner: 'Zobayer Ahmed', opp_amount: 245283.4, probability: 100, stage: 'Closed Won', priority: 'High', color: '#22C55E' },
];
